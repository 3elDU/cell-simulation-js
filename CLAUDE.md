...
sensor, action or the UI gets verified in the running app by the `browser-test` agent — ask to
launch it, and tell it what to look for rather than how to look. A typecheck-clean change is
not a working one.
