...
export const InstructionInfoList = {
  ...
  [Instruction.Photosynthesis]: {
    ...
    color: "black",
    abbreviation: "P",
    name: "Produce energy by photosynthesis",
  },
  [Instruction.GiveEnergy]: {
    backgroundColor: "#f77622",
    color: "white",
    abbreviation: "G",
    name: "Give energy to cell in front",
  },
  [Instruction.AttackCell]: {
    backgroundColor: "#e43b44",
    color: "white",
    abbreviation: "A",
    name: "Attack cell in front",
  },
  [Instruction.RecycleDeadCell]: {
    backgroundColor: "#3e8948",
    color: "white",
    abbreviation: "R",
    name: "Recycle dead cell in front",
  },
  ...
  [Instruction.JumpIfFacingLeft]: {
    ...
    color: "white",
    abbreviation: "L",
    name: "Check if turned left",
  },
  [Instruction.JumpIfFacingRight]: {
    backgroundColor: "#124e89",
    color: "white",
    abbreviation: "R",
    name: "Check if turned right",
  },
  [Instruction.JumpIfFacingUp]: {
    backgroundColor: "#124e89",
    color: "white",
    abbreviation: "U",
    name: "Check if turned up",
  },
  [Instruction.JumpIfFacingDown]: {
    backgroundColor: "#124e89",
    color: "white",
    abbreviation: "D",
    name: "Check if turned down",
  },
  ...
  [Instruction.JumpIfFacingAliveCell]: {
    ...
    color: "white",
    abbreviation: "A",
    name: "Jump if facing alive cell",
  },
  [Instruction.JumpIfFacingDeadCell]: {
    backgroundColor: "#124e89",
    color: "white",
    abbreviation: "D",
    name: "Jump if facing dead cell",
  },
  [Instruction.JumpIfFacingVoid]: {
    backgroundColor: "#124e89",
    color: "white",
    abbreviation: "V",
    name: "Jump if facing void",
  },
  [Instruction.JumpIfFacingRelative]: {
    backgroundColor: "#124e89",
    color: "white",
    abbreviation: "S",
    name: "Jump if facing relative",
  },
  [Instruction.MakeChild]: {
    backgroundColor: "#2ce8f5",
    color: "black",
    abbreviation: "M",
    name: "Make child",
  },
...
export class Gene {
  ...
  clone(): Gene {
    return new Gene(this.instruction, this.opt, this.e, this.b1, this.b2);
  }

  static fromJSON(obj: any): Gene {
    return new Gene(obj.instruction, obj.opt, obj.e, obj.b1, obj.b2);
  }
  ...
  mutate(): boolean {
    ...
    switch (propertyToMutate) {
      case 0:
        this.instruction = randomRangeInclusive(0, Instruction.MakeChild);
      case 1:
        this.opt = Math.random() > 0.5;
      case 2:
        this.e = randomRange(0, config.reproductionRequiredEnergy * 2);
      case 3:
        this.b1 = randomRange(0, config.genomeLength);
      case 4:
        this.b2 = randomRange(0, config.genomeLength);
    }
