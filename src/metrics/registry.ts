...
import { GenerationMetric } from "./generation";
import { SeasonMetric } from "./season";
...
metricsRegistry.register(d(GenerationMetric));
metricsRegistry.register(d(SeasonMetric));
